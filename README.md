...
#### Προγραμματιστική εμπειρία παρεμφερής με την παρούσα εργασία: Διαδικτυακή πλατφόρμα χρήσης για το παιχνίδι [agar.io](https://agar.io), με ενεργούς παγκόσμιους χρήστες, [legendmod.ml](https://legendmod.ml/), και βρίσκεται στο [jimboy3100.github.io](https://github.com/jimboy3100/jimboy3100.github.io) 
...
Οι κάρτες απο την τελευταία κίνηση δεν προσμετρούντε στα κάτω φύλλα. Το moves_left δεν χρησιμοποείται απο το demo παιχνιδιού, σε περίπτωση αργού server θα βλέπαμε από τα φύλλα 
