...
η διαχείρηση των οποίων υλοποιείται στην Php. Η βάση ελέγχει επίσης όλες τις νόμιμες κινήσεις. (Πολλές λειτουργίες)
...
Αρχικά, όταν ανοίγει η ιστοσελίδα, δημιουργεί ενα UID (Session Id) και μοιράζει την τράπουλα τυχαία σε 2 θέσεις.
Όταν φορτώσει για δεύτερη φορά η σελίδα, δημιουργείται δεύτερο UID, και το παιχνίδι ξεκινάει μόλις γίνει η πρώτη κίνηση από τον παίκτη που μπήκε πρώτα.
...
Διαθέτει επιλογή QUIT GAME, η οποία δίωχνει τον παίκτη. Επίσης η επιλογή REFRESH ανανεώνει το σημείο της ιστοσελίδας που δείχνει την παρούσα 
...
Όλες οι ενέργειες ελέγχονται στην βάση (παίξιμο μέχρι 4 φύλλα, έλεγχο σειράς, κτλπ). Σε κάποιες περιπτώσεις έλεγχοι γίνονται και στο User Interface.
...
Όταν ο παίκτης ρίξει τα φύλλα, αυτά αποθηκέυονται στην τελευταία κίνηση, και επι αυτόν μπορεί να επικαλεστεί μπλόφα ο αντίπαλος.
Όταν ρίξει φύλλα ο επόμενος, τα φύλλα της τελευταίας κίνησης προσθέτονται στα κάτω φύλλα.
...
Αντί αυτού, σε περίπτωση που ο επόμενος παίξει, τα κάτω φύλλα δεν πάνε στην άκρη και τα πάσο επαναορίζονται στο 0. 
...
Καταστρέφει το παιχνίδι και τα UID, επιστρέφει κενό μήνυμα, όπως και το DESTROY. Δεν χρησιμοποιείται απο το demo παιχνιδιού, αλλά απο το API Controller
