...
document.addEventListener('DOMContentLoaded', function() {
   ...
   $("#throwCards").hide(); 
	...
	$("#apiController").click(function() {
		window.open("APIcontroller.html");
	}); 	
});
...
function handleGetUsers(data){
	...
	else if (data && JSON.parse(data)){ // gia na leitourgei me header('HTTP/1.1 200 OK'); anti header('Content-type: application/json');
